  ...
  private readonly translations = {
    en: {
      ...
      'landing.docs.subtitle': 'This document outlines the data access standards for files. Please follow the guidance provided for each category.',
        ...
        'asset_store.request_access': 'Request Access',

        // Publisher Profile Page
        'publisher_profile.home': 'Home',
        'publisher_profile.publishers': 'Publishers',
        'publisher_profile.website': 'Website',
        'publisher_profile.joined': 'Joined',
        'publisher_profile.total_resources': 'Total Resources',
        'publisher_profile.published_resources': 'Published Resources',
        'publisher_profile.total_downloads': 'Total Downloads',
        'publisher_profile.verified_resources': 'Verified Resources',
        'publisher_profile.loading_publisher': 'Loading publisher information...',
        'publisher_profile.filters': 'Filters',
        'publisher_profile.resource_type': 'Resource Type',
        'publisher_profile.creative_commons': 'Creative Commons License',
        'publisher_profile.language': 'Language',
        'publisher_profile.all_languages': 'All Languages',
        'publisher_profile.publisher_resources': 'Publisher Resources',
        'publisher_profile.resources_found': 'resources found',
        'publisher_profile.loading_resources': 'Loading resources...',
        'publisher_profile.license': 'License',
        'publisher_profile.download': 'Download',
        'publisher_profile.pagination_total': 'Showing {start}-{end} of {total} resources',
        'publisher_profile.no_resources': 'No resources found for this publisher',

        // Access Request Modal
        'access_request.request_access': 'Request Access',
        'access_request.review_terms': 'Review Terms',
        'access_request.submission_status': 'Request Status',
        'access_request.step_1_title': 'Purpose & Details',
        'access_request.step_1_desc': 'Tell us about your project',
        'access_request.step_2_title': 'Terms & Conditions',
        'access_request.step_2_desc': 'Review licensing terms',
        'access_request.step_3_title': 'Submission',
        'access_request.step_3_desc': 'Request processing',
        'access_request.by': 'by',
        'access_request.purpose_title': 'Project Purpose & Usage',
        'access_request.purpose_subtitle': 'Help us understand how you plan to use this Islamic content',
        'access_request.project_type': 'Project Type',
        'access_request.project_type_required': 'Please select your project type',
        'access_request.select_project_type': 'Select project type...',
        'access_request.expected_usage': 'Expected Usage Volume',
        'access_request.expected_usage_required': 'Please select expected usage',
        'access_request.distribution_method': 'Distribution Method',
        'access_request.distribution_method_required': 'Please select distribution method',
        'access_request.select_distribution': 'Select distribution method...',
        'access_request.target_audience': 'Target Audience',
        'access_request.target_audience_required': 'Please select target audience',
        'access_request.organization': 'Organization',
        'access_request.organization_placeholder': 'Enter organization name (optional)',
        'access_request.justification': 'Project Justification',
        'access_request.justification_required': 'Please provide detailed justification (minimum 50 characters)',
        'access_request.justification_placeholder': 'Describe your project, its Islamic nature, and how this content will be used appropriately...',
        'access_request.terms_title': 'License Terms & Conditions',
        'access_request.terms_subtitle': 'Please review all terms before proceeding',
        'access_request.required': 'Required',
        'access_request.previous': 'Previous',
        'access_request.next': 'Next',
        'access_request.agree_terms': 'I agree to all terms and conditions for Islamic content usage',
        'access_request.review_terms_btn': 'Review Terms & Conditions',
        'access_request.submit_request': 'Submit Access Request',
        'access_request.back': 'Back',
        'access_request.submitting': 'Submitting request...',
        'access_request.processing': 'Processing your access request',
        'access_request.success_title': 'Request Submitted Successfully!',
        'access_request.success_subtitle': 'Your access request has been submitted for review. You will receive an email notification once it has been processed.',
        'access_request.error_title': 'Submission Failed',
        'access_request.submission_error': 'Failed to submit access request. Please try again.',
        'access_request.view_requests': 'View My Requests',
        'access_request.browse_more': 'Browse More Content',
        'access_request.retry': 'Try Again',
      ...
      'profile.marketing_emails': 'Marketing Emails',
      ...
      'profile.connected_apps': 'Connected Applications',
      'profile.account_type': 'Account Type',
      'profile.member_since': 'Member Since',
      'profile.last_login': 'Last Login',
      'profile.save_changes': 'Save Changes',
      'profile.cancel_changes': 'Cancel Changes',
    ...
    ar: {
      ...
      'landing.docs.subtitle': 'يوضح هذا المستند معايير الوصول إلى البيانات في الملفات. يرجى اتباع الإرشادات أدناه لكل فئة.',
        ...
        'asset_store.request_access': 'طلب الوصول',

        // Publisher Profile Page
        'publisher_profile.home': 'الرئيسية',
        'publisher_profile.publishers': 'الناشرين',
        'publisher_profile.website': 'الموقع الإلكتروني',
        'publisher_profile.joined': 'انضم في',
        'publisher_profile.total_resources': 'إجمالي الموارد',
        'publisher_profile.published_resources': 'الموارد المنشورة',
        'publisher_profile.total_downloads': 'إجمالي التحميلات',
        'publisher_profile.verified_resources': 'الموارد المتحققة',
        'publisher_profile.loading_publisher': 'جاري تحميل معلومات الناشر...',
        'publisher_profile.filters': 'المرشحات',
        'publisher_profile.resource_type': 'نوع المورد',
        'publisher_profile.creative_commons': 'رخصة المشاع الإبداعي',
        'publisher_profile.language': 'اللغة',
        'publisher_profile.all_languages': 'جميع اللغات',
        'publisher_profile.publisher_resources': 'موارد الناشر',
        'publisher_profile.resources_found': 'مورد موجود',
        'publisher_profile.loading_resources': 'جاري تحميل الموارد...',
        'publisher_profile.license': 'الرخصة',
        'publisher_profile.download': 'تحميل',
        'publisher_profile.pagination_total': 'عرض {start}-{end} من {total} مورد',
        'publisher_profile.no_resources': 'لم يتم العثور على موارد لهذا الناشر',

        // Access Request Modal
        'access_request.request_access': 'طلب وصول',
        'access_request.review_terms': 'مراجعة الشروط',
        'access_request.submission_status': 'حالة الطلب',
        'access_request.step_1_title': 'الغرض والتفاصيل',
        'access_request.step_1_desc': 'أخبرنا عن مشروعك',
        'access_request.step_2_title': 'الشروط والأحكام',
        'access_request.step_2_desc': 'مراجعة شروط الترخيص',
        'access_request.step_3_title': 'الإرسال',
        'access_request.step_3_desc': 'معالجة الطلب',
        'access_request.by': 'بواسطة',
        'access_request.purpose_title': 'غرض المشروع والاستخدام',
        'access_request.purpose_subtitle': 'ساعدنا في فهم كيف تخطط لاستخدام هذا المحتوى الإسلامي',
        'access_request.project_type': 'نوع المشروع',
        'access_request.project_type_required': 'يرجى تحديد نوع مشروعك',
        'access_request.select_project_type': 'اختر نوع المشروع...',
        'access_request.expected_usage': 'حجم الاستخدام المتوقع',
        'access_request.expected_usage_required': 'يرجى تحديد الاستخدام المتوقع',
        'access_request.distribution_method': 'طريقة التوزيع',
        'access_request.distribution_method_required': 'يرجى تحديد طريقة التوزيع',
        'access_request.select_distribution': 'اختر طريقة التوزيع...',
        'access_request.target_audience': 'الجمهور المستهدف',
        'access_request.target_audience_required': 'يرجى تحديد الجمهور المستهدف',
        'access_request.organization': 'المنظمة',
        'access_request.organization_placeholder': 'أدخل اسم المنظمة (اختياري)',
        'access_request.justification': 'مبرر المشروع',
        'access_request.justification_required': 'يرجى تقديم مبرر مفصل (50 حرف كحد أدنى)',
        'access_request.justification_placeholder': 'اوصف مشروعك وطبيعته الإسلامية وكيف سيتم استخدام هذا المحتوى بشكل مناسب...',
        'access_request.terms_title': 'شروط وأحكام الترخيص',
        'access_request.terms_subtitle': 'يرجى مراجعة جميع الشروط قبل المتابعة',
        'access_request.required': 'مطلوب',
        'access_request.previous': 'السابق',
        'access_request.next': 'التالي',
        'access_request.agree_terms': 'أوافق على جميع الشروط والأحكام لاستخدام المحتوى الإسلامي',
        'access_request.review_terms_btn': 'مراجعة الشروط والأحكام',
        'access_request.submit_request': 'إرسال طلب الوصول',
        'access_request.back': 'رجوع',
        'access_request.submitting': 'جاري إرسال الطلب...',
        'access_request.processing': 'جاري معالجة طلب الوصول الخاص بك',
        'access_request.success_title': 'تم إرسال الطلب بنجاح!',
        'access_request.success_subtitle': 'تم إرسال طلب الوصول للمراجعة. ستتلقى إشعار بالبريد الإلكتروني عند معالجته.',
        'access_request.error_title': 'فشل في الإرسال',
        'access_request.submission_error': 'فشل في إرسال طلب الوصول. يرجى المحاولة مرة أخرى.',
        'access_request.view_requests': 'عرض طلباتي',
        'access_request.browse_more': 'تصفح المزيد من المحتوى',
        'access_request.retry': 'حاول مرة أخرى',
        'access_request.cancel': 'إلغاء',
      ...
      'profile.push_notifications': 'الإشعارات المنبثقة',
      'profile.marketing_emails': 'رسائل التسويق الإلكترونية',
      'profile.security_alerts': 'تنبيهات الأمان',
      'profile.change_password': 'تغيير كلمة المرور',
      'profile.two_factor_auth': 'المصادقة الثنائية',
      'profile.active_sessions': 'الجلسات النشطة',
      'profile.api_keys': 'مفاتيح API',
      'profile.connected_apps': 'التطبيقات المربوطة',
      ...
      'profile.cancel_changes': 'إلغاء التغييرات',
