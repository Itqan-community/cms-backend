...
urlpatterns = [
    # Authentication endpoints - WITH trailing slashes to match OpenAPI spec
    ...
    path('auth/profile/', views.user_profile, name='user_profile'),  # GET and PUT on same endpoint
    ...
    # Assets endpoints - WITH trailing slashes to match OpenAPI spec
