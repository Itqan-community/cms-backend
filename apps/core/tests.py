...
class BaseTestCase(TestCase):
    ...
    def tearDownClass(cls) -> None:
        ...
        try:
            ...
            logger.warning("Failed to disable storage override in BaseTestCase.tearDownClass", exc_info=exc)
        # Stop moto mock to clean up between tests
        try:
            cls.mock_aws.stop()
        except Exception as exc:
            logger.warning("Failed to stop moto mock in BaseTestCase.tearDownClass", exc_info=exc)
