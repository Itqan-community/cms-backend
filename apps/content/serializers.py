    ...
    def from_publishing_organization(cls, org):
        ...
        return {
            ...
            "thumbnail_url": get_file_url(
                org.icone_image_url,
            ),  # Map icone_image_url -> thumbnail_url
            "bio": org.bio or "",
...
class AssetSummarySerializer(serializers.Serializer):
    ...
    def from_asset_model(cls, asset, request=None):
        ...
        return {
            ...
            "publisher": PublisherSummarySerializer.from_publishing_organization(
                asset.publishing_organization,
            ),
            "has_access": cls._check_user_access(asset, request),
            "download_count": asset.download_count,
...
class AssetDetailSerializer(serializers.Serializer):
    ...
    def from_asset_model(cls, asset, request=None):
        ...
        related_data = [
            {
                ...
                "publisher": PublisherSummarySerializer.from_publishing_organization(
                    related.publishing_organization,
                ),
            }
        ...
        return {
            ...
            "technical_details": AssetTechnicalDetailsSerializer.from_asset_model(
                asset,
            ),
...
class UsageEventSerializer(serializers.ModelSerializer):
    ...
    developer_user_email = serializers.CharField(
        source="developer_user.email",
        read_only=True,
    )
