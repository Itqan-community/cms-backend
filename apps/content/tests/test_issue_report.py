...
class IssueReportUnitTests(BaseTestCase):
    ...
    def test_repository_crud(self):
        ...
        self.assertEqual(self.asset, report.content_object)
    ...
    def test_repository_filtering(self):
        ...
        # Assert
        self.assertEqual(2, qs_ctype.count())
    ...
    def test_service_publisher_filtering(self):
        ...
        report1 = self.service.create_issue_report(self.user, "asset", self.asset.id, "Report 1 desc")
        report2 = self.service.create_issue_report(self.user, "asset", asset2.id, "Report 2 desc")
