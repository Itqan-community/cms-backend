...
class TafsirVersionListTest(TafsirVersionBaseTest):
    def test_list_versions_where_valid_slug_should_return_versions(self):
        ...
        baker.make(AssetVersion, asset=self.tafsir, resource_version=rv1, name="V1")
        baker.make(AssetVersion, asset=self.tafsir, resource_version=rv2, name="V2")
...
class TafsirVersionUpdateTest(TafsirVersionBaseTest):
    def setUp(self):
        ...
        self.version = baker.make(AssetVersion, asset=self.tafsir, resource_version=rv, name="Old Name")
...
class TafsirVersionDeleteTest(TafsirVersionBaseTest):
    def test_delete_version_should_return_204(self):
        ...
        version = baker.make(AssetVersion, asset=self.tafsir, resource_version=rv)
