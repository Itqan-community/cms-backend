...
class CategoryListTest(BaseTestCase):
    ...
    def test_list_categories_returns_all_choices(self):
        ...
        # Act
        response = self.client.get("/portal/resource-categories/")
    ...
    def test_list_categories_is_static(self):
        ...
        response1 = self.client.get("/portal/resource-categories/")
        ...
        response2 = self.client.get("/portal/resource-categories/")
