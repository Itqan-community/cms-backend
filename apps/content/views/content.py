...
from apps.api.permissions import DistributionPermission
from apps.api.permissions import ResourcePermission
from apps.content.models import Distribution
from apps.content.models import Resource
from apps.content.serializers import DistributionSerializer
    ...
    def get_queryset(self):
        ...
        if self.request.user.is_developer():
            ...
            return queryset.filter(
                Q(
                    access_requests__requester=self.request.user,
