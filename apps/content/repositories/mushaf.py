...
class MushafRepository:
    ...
    def create_mushaf(
        ...
        *,
        ...
        """
        Create an Asset for a new Mushaf.
        """
    ...
    def update_mushaf(
        ...
        """
        Update mushaf asset fields. Handles translation fields via modeltranslation
    ...
    def delete_mushaf(self, asset: Asset) -> None:
        """
        Delete the mushaf asset.
        """
        asset.delete()

    def get_mushaf_version(self, asset: Asset, version_id: int) -> AssetVersion | None:
        """
    ...
    def delete_mushaf_version(self, version: AssetVersion) -> None:
        """
