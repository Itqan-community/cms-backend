    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(blank=True, help_text="Detailed publisher description"),
                ),
                (
                    "address",
                    models.CharField(blank=True, help_text="Publisher address", max_length=255),
                ),
                ("website", models.URLField(blank=True, help_text="Publisher website")),
                (
                    "is_verified",
                    models.BooleanField(default=True, help_text="Whether publisher is verified"),
                ),
                (
                    "contact_email",
                    models.EmailField(
