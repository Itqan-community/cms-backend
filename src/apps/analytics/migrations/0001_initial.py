    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, help_text="Size of the request in bytes"
                    ),
                ),
                (
                    "response_size",
                    models.PositiveIntegerField(
                        default=0, help_text="Size of the response in bytes"
                    ),
                ),
                (
                    "ip_address",
                ...
                (
                    "user_agent",
                    models.TextField(help_text="User agent string from the client"),
                ),
                (
                    "metadata",
                    models.JSONField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user"], name="legacy_usag_user_id_bf6810_idx"
                    ),
                    models.Index(
                        fields=["resource"], name="legacy_usag_resourc_dbe3be_idx"
                    ),
                    models.Index(
                        fields=["distribution"], name="legacy_usag_distrib_b233b0_idx"
                    ),
                    models.Index(
                        fields=["event_type"], name="legacy_usag_event_t_f17102_idx"
                    ),
                    models.Index(
                        fields=["occurred_at"], name="legacy_usag_occurre_fded4c_idx"
                    ),
                    models.Index(
                        fields=["ip_address"], name="legacy_usag_ip_addr_97a195_idx"
                    ),
                    models.Index(
                        fields=["user", "occurred_at"],
                        name="legacy_usag_user_id_6909e5_idx",
                    ),
                    models.Index(
                        fields=["resource", "occurred_at"],
                        name="legacy_usag_resourc_b3368d_idx",
                    ),
                    models.Index(
                        fields=["event_type", "occurred_at"],
                        name="legacy_usag_event_t_eb7078_idx",
                    ),
                ],
            },
        ),
