    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['resource'], name='legacy_lice_resourc_25bfb7_idx'), models.Index(fields=['license_type'], name='legacy_lice_license_4c5f35_idx'), models.Index(fields=['requires_approval'], name='legacy_lice_require_049c0f_idx'), models.Index(fields=['effective_from'], name='legacy_lice_effecti_27b687_idx'), models.Index(fields=['expires_at'], name='legacy_lice_expires_9aa35a_idx')],
            },
        ),
        migrations.CreateModel(
            name='AccessRequest',
