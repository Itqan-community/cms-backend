    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["resource"], name="legacy_lice_resourc_25bfb7_idx"
                    ),
                    models.Index(
                        fields=["license_type"], name="legacy_lice_license_4c5f35_idx"
                    ),
                    models.Index(
                        fields=["requires_approval"],
                        name="legacy_lice_require_049c0f_idx",
                    ),
                    models.Index(
                        fields=["effective_from"], name="legacy_lice_effecti_27b687_idx"
                    ),
                    models.Index(
                        fields=["expires_at"], name="legacy_lice_expires_9aa35a_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "requested_at",
                    models.DateTimeField(
                        auto_now_add=True, help_text="When the request was submitted"
                    ),
                ),
                (
                    "reviewed_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["requester"], name="access_requ_request_b658ce_idx"
                    ),
                    models.Index(
                        fields=["distribution"], name="access_requ_distrib_ef01ee_idx"
                    ),
                    models.Index(
                        fields=["status"], name="access_requ_status_fdceb3_idx"
                    ),
                    models.Index(
                        fields=["priority"], name="access_requ_priorit_4740b3_idx"
                    ),
                    models.Index(
                        fields=["requested_at"], name="access_requ_request_787a23_idx"
                    ),
                    models.Index(
                        fields=["reviewed_at"], name="access_requ_reviewe_5c7d36_idx"
                    ),
                    models.Index(
                        fields=["notification_sent"],
                        name="access_requ_notific_0d23f7_idx",
                    ),
                    models.Index(
                        fields=["status", "requested_at"],
                        name="access_requ_status_baf326_idx",
                    ),
                    models.Index(
