...
sidebar_position: 3
title: التصفيح
description: كيفية التنقل بين مجموعات النتائج الكبيرة باستخدام معاملَي page و page_size.
---
...
استخدم `count` من [غلاف الاستجابة](/docs/guides/response-structure) لتحديد عدد الصفحات، ثم زد `page` حتى تحصل على جميع السجلات.
...
**انظر أيضاً:** [هيكل الاستجابة](/docs/guides/response-structure) · [البحث والتصفية والترتيب](/docs/guides/search-filter-order) · [معالجة الأخطاء](/docs/guides/errors)
